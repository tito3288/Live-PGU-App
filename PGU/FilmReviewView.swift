                ...
                List{
                    ...
                    HStack{
                        VStack(alignment: .leading, spacing: 0) {
                            Text("Coach Rob Teaches Single - Dribble Counter Moves")
                                .font(.title2)
                                .fontWeight(.bold)
                        ...
                        Button(action: {
                            let videoName = "pgu-video1" // Example video name
                            togglePlayPause(for: videoName)                        }) {
                                Image(systemName: selectedVideo == "pgu-video1" && isVideoPlaying ? "pause.fill" : "play.fill")
                    ...
                    HStack{
                        VStack(alignment: .leading, spacing: 0) {
                            Text("Coach Rob Teaches How To Finish With The Opposite Leg")
                                .font(.title2)
                                .fontWeight(.bold)
                                .foregroundColor(Color(hex: "0f2d53"))// Style for regular text
                        }
                        ...
                        Button(action: {
                            let videoName = "pgu-video7" // Example video name
                            togglePlayPause(for: videoName)                        }) {
                                Image(systemName: selectedVideo == "pgu-video7" && isVideoPlaying ? "pause.fill" : "play.fill")
                                    .frame(alignment: .trailing)
                                    .padding(10)
                                    .background(Color(hex: "c7972b"))
                                    .foregroundColor(.white)
